    ...
    <div class="col-12 col-lg-8">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">
                    <i class="bi bi-pencil text-warning me-2"></i>Edit Kegiatan
                </h5>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.kegiatan.update', $kegiatan) }}" method="POST">
                    ...
                    <hr class="my-4">
                    <div class="gps-toggle-card {{ $kegiatan->isGpsEnabled() ? 'active' : '' }}" id="gpsToggleCard">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" role="switch" id="enableGps" 
                                   {{ $kegiatan->isGpsEnabled() || old('latitude') ? 'checked' : '' }}>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <input type="number" 
                                       ...
                                       id="radius_meter" 
                                       name="radius_meter" 
                                       value="{{ old('radius_meter', $kegiatan->radius_meter ?? 100) }}"
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function initMap() {
        ...
        map = L.map('mapEdit').setView([initLat, initLng], 16);
